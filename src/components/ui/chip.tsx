    ...
    <button
      ...
      className={cn(
        ...
        active
          ...
          : "bg-white dark:bg-slate-900 dark:bg-slate-800 text-slate-600 dark:text-slate-400 dark:text-slate-300 ring-slate-200 dark:ring-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800/50 dark:hover:bg-slate-700",
        className
      )}
    >
      {icon}
