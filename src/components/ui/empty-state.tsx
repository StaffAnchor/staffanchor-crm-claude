...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        "rounded-ros-xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 py-16 flex flex-col items-center justify-center text-center px-6",
        className
      )}
    >
