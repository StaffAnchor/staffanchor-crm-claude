...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  ...
  secondary:
    "bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 ring-1 ring-slate-200 dark:ring-slate-700",
  ...
  return (
    <button
      className={cn(
        ...
        "ros-focusable inline-flex items-center justify-center font-medium rounded-ros-lg transition-all duration-200 ease-ros disabled:opacity-60 disabled:cursor-not-allowed",
